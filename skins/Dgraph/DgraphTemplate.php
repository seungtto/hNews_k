			  ...
			  <div class="container">
				<div class="row">
				  <!--<div class="col-6 col-desktop-4">
					<<figure class="page-logo"><a href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] )?>">
        ...
        <div class="row">
          ...
          <!--<div class="col-4 col-tablet-2">
            <nav class="page-footer-nav">
              <h6 class="page-footer-nav__title">Author</h6>
              <ul class="page-footer-nav__list">
                <li class="page-footer-nav__item"><a href="https://dgraph.io/" title="Learn more about us" class="page-footer-nav__link">Team Journalism</a></li>
              </ul>
            </nav>
          </div>-->
          <div class="col-4 col-tablet-2">
            <nav class="page-footer-nav">
              ...
              <ul class="page-footer-nav__list">
                <li class="page-footer-nav__item"><a href="https://github.com/seungtto/hNews_k" title="Wa are on GitHub, check it out." target="_blank" class="page-footer-nav__link link-alias">GitHub</a></li>
              </ul>
            </nav>
          </div>
          <div class="col-4 col-tablet-2">
            <nav class="page-footer-nav">
              <h6 class="page-footer-nav__title">Contact</h6>
              <ul class="page-footer-nav__list">
                <li class="page-footer-nav__item"><a href="mailto:seungtto@gmail.com" title="Mail to administrator" target="_blank" class="page-footer-nav__link link-alias">Email</a></li>
              </ul>
            </nav>
          </div>
        </div>
        <div class="row">
          <div class="col-12"><span class="imprint__copyrights">Powered by <a href="https://www.mediawiki.org/">MediaWiki</a> | Skined by <a href="https://dgraph.io">Dgraph Labs, Inc.</a></span></div>
        </div>
      </div>
    </footer>
    <!-- / page-footer-->
